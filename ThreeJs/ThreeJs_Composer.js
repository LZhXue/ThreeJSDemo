...
THREE.ThreeJs_Composer = function(_renderer, _scene, _camera, _options, _selectobject) {
	...
	function onMouseClick(event) {
		...
		if (intersects[0].object.name == "地板" || (intersects[0].object.name == "") || (intersects[0].object.name == "墙面")) {
			$("#label").attr("style", "display:none;"); //隐藏说明性标签
			selectedObjects.pop();
		} else {
		...
		if (intersects[0].object.name == "门1左" || intersects[0].object.name == "门2左") {
			if (door_state_left1) {
		...
		} else if (intersects[0].object.name == "门1右" || intersects[0].object.name == "门2右") {
